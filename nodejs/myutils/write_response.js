      ...
      res.writeHead(404,
        {
          ...
          "Refresh"     : "5;url=http://ohayosoro.me/resource?type=html&name=matteteainouta"
        });
      res.write("<!DOCTYPE html><html><head><title>404 NOT FOUND</title></head><body style=\"font-family: 'Microsoft Yahei','Helvetica Neue',Helvetica,Arial,sans-serif; margin: 100px;\"><h1 style=\"font-size: 100px;\">:(</h1><h2>404 NOT FOUND</h2><p>We are sorry to say that we cannot find the things which you want to get. m( _ _ )m</p><p>Let's go back to the recommendeng of this week -> #Mattete aino uta# by Aqours.</p><p>REDIRECTION IN THREE SECONDS...</p></body></html>");
      res.end();
      break;
    case 406:
